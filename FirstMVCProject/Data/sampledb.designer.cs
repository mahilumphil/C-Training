...
namespace FirstMVCProject.Data
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="DBSample")]
    ...
    partial void DeleteClient(Client instance);
		...
		public sampledbDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["DBSampleConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class Client : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _ClientTelephoneNo;
		
		private string _ClientCellphoneNo;
    ...
    partial void OnClientTelephoneNoChanging(string value);
    partial void OnClientTelephoneNoChanged();
    partial void OnClientCellphoneNoChanging(string value);
    partial void OnClientCellphoneNoChanged();
    ...
    partial void OnUserIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ClientAddress", DbType="NVarChar(50)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ClientTelephoneNo", DbType="NVarChar(50)")]
		public string ClientTelephoneNo
		{
			get
			{
				return this._ClientTelephoneNo;
			}
			set
			{
				if ((this._ClientTelephoneNo != value))
				{
					this.OnClientTelephoneNoChanging(value);
					this.SendPropertyChanging();
					this._ClientTelephoneNo = value;
					this.SendPropertyChanged("ClientTelephoneNo");
					this.OnClientTelephoneNoChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ClientCellphoneNo", DbType="NVarChar(50)")]
		public string ClientCellphoneNo
		{
			get
			{
				return this._ClientCellphoneNo;
			}
			set
			{
				if ((this._ClientCellphoneNo != value))
				{
					this.OnClientCellphoneNoChanging(value);
					this.SendPropertyChanging();
					this._ClientCellphoneNo = value;
					this.SendPropertyChanged("ClientCellphoneNo");
					this.OnClientCellphoneNoChanged();
				}
			}
		}
